...
from inkslab.python.nmt_autosum import inference
from inkslab.python.nmt_autosum import train
from inkslab.python.common import evaluation_utils
from inkslab.python.common import misc_utils as utils
from inkslab.python.common import vocab_utils
...
def add_arguments(parser):
    ...
    parser.add_argument("--encoder_type", type=str, default="uni", choices=["uni", "bi", "gnmt"], help="""\
    ...
    parser.add_argument(
        "--attention_architecture", type=str, default="standard", choices=["standard", "gnmt", "gnmt_v2"],
        help="""\
          ...
          """)
    parser.add_argument(
        "--output_attention", type="bool", nargs="?", const=True, default=True,
        help="""\
          ...
          """)
    parser.add_argument(
        "--pass_hidden_state", type="bool", nargs="?", const=True, default=True,
        help="""\
    ...
    parser.add_argument("--warmup_scheme", type=str, default="t2t", choices=["t2t"], help="""\
          ...
          """)
    parser.add_argument(
        "--decay_scheme", type=str, default="", choices=["", "luong234", "luong5", "luong10"], help="""\
    ...
    # 初始化器参数
    parser.add_argument("--init_op", type=str, default="uniform", choices=["uniform", "glorot_normal", "glorot_uniform"])
    ...
    # 默认设置
    parser.add_argument("--unit_type", type=str, default="lstm", choices=["lstm", "gru", "layer_norm_lstm", "nas"])
    ...
    # SPM
    parser.add_argument("--subword_option", type=str, default="", choices=["", "bpe", "spm"],
                        help="""\
