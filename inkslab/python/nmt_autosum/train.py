...
from inkslab.python.models import attention_model
from inkslab.python.models import gnmt_model
from inkslab.python.nmt_autosum import inference
from inkslab.python.models import base_model as nmt_model
from inkslab.python.models import model_helper
from inkslab.python.common import misc_utils as utils
from inkslab.python.common import nmt_utils
...
def _sample_decode(model, global_step, sess, hparams, iterator, src_data,
    ...
    utils.print_out(b"    generate: " + translation)
