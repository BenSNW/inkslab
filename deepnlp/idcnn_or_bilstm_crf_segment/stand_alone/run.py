...
from deepnlp.idcnn_or_bilstm_crf_segment.stand_alone.train import train
from deepnlp.idcnn_or_bilstm_crf_segment.stand_alone.predict import predict, predict_batch
...
if __name__ == "__main__":
    ...
    parser.add_argument('--clean', type=bool, default=False, help="Whether clean the model")
    ...
    parser.add_argument('--predict_out_file', type=str, default="example.raw", help="Path for predict data")

    parser.add_argument('--model_type', type=str, default="idcnn", help="Model type, can be idcnn or bilstm")
