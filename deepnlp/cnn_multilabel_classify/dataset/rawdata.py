...
def get_data(data_dir):
    ...
    _save_vocab(word_idx_map, os.path.join(data_dir, "dic/word_to_id.txt"))
...
def get_idx_from_file(data_dir):
    word_to_id_file = os.path.join(data_dir, "dic/word_to_id.txt")
    file = codecs.open(word_to_id_file, encoding='utf-8')
    vocab_dict = {}
    for line in file:
        pair = line.replace("\n", "").split("\t")
