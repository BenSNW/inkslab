...
import argparse
from deepnlp.joint_segment_tagger_bilstm_crf.train import train_seg_tagger
from deepnlp.joint_segment_tagger_bilstm_crf.test import test_seg_tagger

def main(args):

    if args.process == tf.estimator.ModeKeys.TRAIN:
        train_seg_tagger.train(args)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_dir', required=False, type=str, default='data/bi_lstm_crf_segment/ckpt')
    parser.add_argument('--data_dir', required=False, type=str, default='data/bi_lstm_crf_segment/data')
    parser.add_argument('--utils_dir', required=False, type=str, default='data/bi_lstm_crf_segment/utils')
    parser.add_argument('--vocab_dir', required=False, type=str, default='data/bi_lstm_crf_segment/vocab')
