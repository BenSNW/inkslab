...
from deepnlp.idcnn_or_bilstm_crf_ner.dataset.data_utils import load_word2vec, input_from_line

from deepnlp.idcnn_or_bilstm_crf_ner.utils import get_logger, create_model, load_config
