...
from deepnlp.glove.dataset.database import *
from deepnlp.glove.model import GloVeModel


def train(args):
    print(os.path.abspath(os.path.join(args.data_dir, "train_little.txt")))
    corpus = build_corpus(os.path.abspath(os.path.join(args.data_dir, "train_little.txt")))
